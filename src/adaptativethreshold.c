...
if(img2==NULL)
  ...
  if (flag==0)
	...
	flag=strcmp(nom2,"THRESH_BINARY_INV");
  	if (flag==0)
  		{
		cvAdaptiveThreshold( img1, img2,param1[0],CV_ADAPTIVE_THRESH_MEAN_C,CV_THRESH_BINARY_INV,param2[0],param3[0]);
		IplImg2Mat(img2, 7);
  ...
  if (flag==0)
  	...
  	if (flag==0)
  		{
		cvAdaptiveThreshold( img1, img2,param1[0],CV_ADAPTIVE_THRESH_GAUSSIAN_C,CV_THRESH_BINARY,param2[0],param3[0]);
		IplImg2Mat(img2, 7);
	...
	flag=strcmp(nom2,"THRESH_BINARY_INV");
  	if (flag==0)
  		{
		cvAdaptiveThreshold( img1, img2,param1[0],CV_ADAPTIVE_THRESH_GAUSSIAN_C,CV_THRESH_BINARY_INV,param2[0],param3[0]);
		IplImg2Mat(img2, 7);
